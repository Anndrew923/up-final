 ...
 */
function scaleBucket({ tierId, scoreRange, populationClass, summaryHuman }) {
  return {
    tierId,
    scoreRange,
    populationClass,
    summaryHuman,
    neuro_male: MOCK_NEURO_MALE,
    neuro_female: MOCK_NEURO_FEMALE,
    volume_male: MOCK_VOLUME_MALE,
    volume_female: MOCK_VOLUME_FEMALE,
  };
}
