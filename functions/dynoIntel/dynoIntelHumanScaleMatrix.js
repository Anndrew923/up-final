/**
 * v3.3.2 — Shared population-class pyramid (overall anchor + status prefix middle segment).
 * DESIGN INTENT: International competitive ladder labels; 0% vehicle lexicon.
 */
