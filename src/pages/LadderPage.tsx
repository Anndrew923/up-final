    ...
    <main className="ui-shell-compact relative z-10 max-w-3xl space-y-4 bg-[#090b0e]">
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden" aria-hidden>
        ...
        {/*
          ...
          under the fixed icons. Keep glow below the integrated sticky header — do not bleed into shell-top/HUD.
        */}
      ...
      <section className="ui-card relative z-0 min-h-[50vh] border border-slate-800/70 bg-gradient-to-b from-slate-900/70 to-slate-950/80 p-0 shadow-2xl">
        {/*
          Integrated sticky header (WHY): One title row lives inside the list card so we drop the
          duplicate「排名」block and the space-y gutter between a floating card and the list.
          Sticky uses compact HUD clearance; do not put overflow-hidden on this section (breaks stickiness).
        */}
