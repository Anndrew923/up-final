...
import { ReferenceDataBlock, ReferenceFootnote, ReferenceLabelledLine } from './AssessmentReferenceProse';
 ...
 * WHY: Keep CardioAssessmentPage presentational wiring thin; clocks stay sourced from logic/core.
 */
export const Run5KmSpecReferencePanel: FC = () => {
  ...
  return (
    <div className="space-y-3">
      <ReferenceFootnote role="note">{t('cardio.run5kmSpec.disclaimer')}</ReferenceFootnote>
      <ReferenceDataBlock
