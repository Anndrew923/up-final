      ...
      {NAV_ITEMS.map((item, index) => {
        ...
        return (
          <NavLink
            ...
            className={({ isActive }) =>
              [
                'relative z-10 flex h-16 basis-1/5 flex-col items-center justify-center gap-0.5 px-1 text-center transition-all duration-300',
          ...
          >
            {({ isActive }) => (
              <>
                ...
                <NavTabLabels labelKey={item.labelKey} accent={isActive} />
                {isActive ? (
