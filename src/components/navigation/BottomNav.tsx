...
const TAB_LINK_BASE =
  'relative flex min-w-0 flex-1 basis-0 flex-col items-center justify-center text-center motion-safe:transition-[transform,opacity] motion-safe:duration-100 motion-safe:ease-report-ease motion-reduce:transition-none';
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    TAB_LINK_BASE,
                    CENTER_TAB_SIZING,
                    'z-20 -translate-y-4 motion-safe:transition-[transform,opacity] motion-safe:duration-100 motion-safe:ease-report-ease motion-reduce:transition-none',
                ...
                {({ isActive }) => {
                  ...
                  return (
                    <>
                      <div
                        className={[
                          'relative flex h-16 w-16 shrink-0 items-center justify-center motion-safe:transition-[transform,opacity] motion-safe:duration-100 motion-safe:ease-report-ease motion-reduce:transition-none',
